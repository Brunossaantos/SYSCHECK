...
<head>
    ...
    <title>Consulta de Tipos de Checklist</title>
...
<body class="bg-gray-900 text-white min-h-screen flex flex-col items-center p-8">
    ...
    <div class="w-full flex justify-between items-center mb-8 max-w-6xl mx-auto">
        <a href="/syscheck/checklist/"
            class="bg-gray-500 hover:bg-gray-600 w-20 h-12 flex items-center justify-center text-center rounded-lg text-white font-medium transition transform hover:scale-105">
            Voltar
        </a>
    ...
    <h1 class="text-3xl font-bold mb-8 text-center">Consulta de Tipos de Checklist</h1>
