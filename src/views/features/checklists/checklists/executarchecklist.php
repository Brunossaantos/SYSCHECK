...
<body class="bg-slate-900 pt-28 p-4">
    ...
    <script>
        ...
        document.getElementById("inputFoto").addEventListener("change", function() {
            ...
            fotos[etapaFoto] = true;

            localStorage.setItem(
                "checklist_fotos_" + idChecklist,
                JSON.stringify(fotos)
            );

            console.log("FOTO SALVA LOCAL:", fotos);
        ...
        function reprovar(numero) {
            ...
            fetch(`/syscheck/etaparealizada/reprovarEtapa/${idChecklist}/${fkTipo}/${numero}/${encodeURIComponent(obs)}`);
        ...
        window.onload = function() {
            ...
            for (let numero in respostas) {
                ...
                if (estado) {
                    ...
                    if (estado.corBorda === "aprovado") {
                        card.classList.add("aprovado");
                    }

                    if (estado.corBorda === "reprovado") {
            ...
            for (let numero in fotos) {
                ...
                let btn = document.getElementById("foto_" + numero);
        ...
        function restaurarFotos() {
            ...
            for (let etapa in fotos) {
                ...
                mini.src = fotos[etapa][0];
                mini.classList.remove("hidden");

                document.getElementById("foto_status_" + etapa).classList.remove("hidden");
        ...
        function finalizarChecklist(btn) {
            ...
            for (let i = 1; i <= totalEtapas; i++) {
                ...
                if (!respostas[i]) {
                    ...
                    document.getElementById("etapa_" + i)
                        .scrollIntoView({
                            behavior: "smooth",
                            block: "center"
                        });
        ...
        window.onload = function() {
            ...
            console.log("LOCALSTORAGE FOTOS:",
                localStorage.getItem("checklist_fotos_" + idChecklist)
            );
