    ...
    <div class="container mt-5">
        <div class="table-container">
            ...
            <div class="d-flex justify-content-center mt-3 btn-group-custom">
                <a href="/syscheck/etaparealizada/confirmaretapa/<?= $idChecklist ?>/<?= $fkTipo ?>/<?= $numeroEtapa ?>/<?= urlencode($observacao) ?>" class="btn btn-success"><strong>Aprovado</strong></a>
                <a href="/syscheck/etaparealizada/reprovarEtapa/<?= $idChecklist ?>/<?= $fkTipo ?>/<?= $numeroEtapa ?>/<?= urlencode($observacao) ?>" class="btn btn-warning text-white"><strong>Reprovado</strong></a>
                <button class="btn btn-primary" data-toggle="modal" data-target="#modalFoto"><strong>Foto</strong></button>
                <!-- Botão para abrir o modal -->
                <button class="btn btn-danger" data-toggle="modal" data-target="#modalObservacao"><strong>Observação</strong></button>
            </div>
        </div>
    </div>
